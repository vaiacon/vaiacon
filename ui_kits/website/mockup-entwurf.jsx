...
const FAQS = [
  ...
  ['Was ist vaiaconAcademy?', 'Die vaiaconAcademy ist unsere Selbstlern-Plattform: 11 Lernpfade mit 58 kurzen Lektionen zu KI im KMU-Alltag. Alle Lektionen sind kostenlos — kein Abo, keine Verpflichtungen.'],
    ...
    <section id="academy" className="mock-section">
      <div className="mock-wrap">
        <div className="mock-center">
          ...
          <p className="mock-lead" style={{ maxWidth: 760 }}>Die <ProductName name="Academy" /> ist unsere Selbstlern-Plattform: 58 kurze Lektionen in 11 Lernpfaden. Jeder Plan ist für sich abgeschlossen und dauert 20 bis 45 Minuten — Sie starten dort, wo es bei Ihnen brennt.</p>
        </div>
        <div className="mock-academy-feature">
          <div className="mock-academy-feature__copy">
            ...
            <p>58 kurze Lektionen in 11 Lernpfaden: Sie lernen genau das, was in Ihrem KMU gerade weiterhilft - verständlich, praxisnah und in Ihrem Tempo.</p>
